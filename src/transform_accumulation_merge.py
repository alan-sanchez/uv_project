...
class TransformPCL(object):
    ...
    def callback_combined_pcl2(self, pcl2_msg):
        ...
        if self.command == "start":
            ...
            uv_light_cloud = self.transform_pointcloud(pcl_cloud,"/uv_light_link")

            self.accumulator(uv_light_cloud,base_cloud)


    def accumulator(self, uv_light_pcl, baselink_pcl):
        """
