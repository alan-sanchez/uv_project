...
class ExecutePath(object):
    ...
    def __init__(self):
        ...
        ##
        self.velocity = 0.19#0.278 # 0.19 #0.571
    ...
    def plan_cartesian_path(self):
        ...
        """
        ## Cartesian waypoints       
        waypoints = [Pose(Point(0.845, 0.038, 1.23),Quaternion(0.00, -0.00, -0.00,  1.00)),
                     Pose(Point(0.838,-0.036, 1.25),Quaternion(0.00, -0.00, -0.00,  1.00)),
                     Pose(Point(0.838,-0.121, 1.23),Quaternion(0.00, -0.00, -0.00,  1.00)),
                     Pose(Point(0.80 ,-0.121, 1.23),Quaternion(0.00, -0.00, -0.00,  1.00)),
                     Pose(Point(0.80,  0.038, 1.23),Quaternion(0.00, -0.00, -0.00,  1.00)),
                    ]
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        print("")
        print("====== Press 'Enter' to execute cone motion =======")
        raw_input()
