...
class AccumulationMap:
    ...
    def __init__(self):
        ...
        self.pointcloud_sub  = rospy.Subscriber('/combined_filtered_image_and_depthmap', PointCloud2,        self.callback_pointcloud)
        self.stop_sub        = rospy.Subscriber('/start',                                String,            self.callback_start_command)
